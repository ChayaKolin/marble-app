...
public class OrderService {
    ...
    static {
        ...
        VALID_TRANSITIONS.put(AWAITING_INSTALLATION,       Set.of(AWAITING_CUSTOMER_APPROVAL, PENDING_REPAIR));
        VALID_TRANSITIONS.put(AWAITING_CUSTOMER_APPROVAL, Set.of(COMPLETED, PENDING_REPAIR));
        VALID_TRANSITIONS.put(PENDING_REPAIR,              Set.of(AWAITING_INSTALLATION, AWAITING_CUSTOMER_APPROVAL, COMPLETED));
