...
public record OrderResponse(
        ...
        String notes,
        // Optional cash breakdown recorded at measurement time
        BigDecimal measurementPaymentTotal,
        BigDecimal measurementPaymentToConsultant,
        BigDecimal measurementPaymentToMeasurer,
    ...
    public static OrderResponse from(Order o) {
        return new OrderResponse(
                ...
                o.getNotes(),
                o.getMeasurementPaymentTotal(),
                o.getMeasurementPaymentToConsultant(),
                o.getMeasurementPaymentToMeasurer(),
